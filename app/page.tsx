...
export default function Home() {
  return (
      ...
      <section className="w-full py-12 md:py-24 lg:py-1">
        <div className="container  grid items-center gap-6 lg:grid-cols-[1fr_500px] lg:gap-12 xl:grid-cols-[1fr_550px]">
          ...
          <div className="flex flex-col justify-center space-y-4">
            <h1 className="text-3xl font-bold tracking-tighter sm:text-4xl md:text-5xl xl:text-6xl/none">Studio Vip</h1>
            ...
            <Button className="w-fit">Cadastre-Se</Button>
          </div>
        </div>
        <div>
        <div className="mt-20 w-900 text-2xl gap-6 flex mt-6 mx-auto w-fit p-8 bg-zinc-300 rounded-lg  ">
            <Select>
              <SelectTrigger className="w-[280px]">
                <SelectValue placeholder="Localizacao" />
              </SelectTrigger>
              <SelectContent>
                <SelectItem value="loc">Barueri</SelectItem>
                <SelectItem value="loc">Itapevi</SelectItem>
                <SelectItem value="loc">Cotia</SelectItem>
              </SelectContent>
              </Select>
        ...
        <div className="grid mt-32 mx-9 grid-cols-2">
        ...
        <Image
          ...
          />
          <div className="">
          <h1 className="font-bold  text-4xl">Agendamento Online</h1>
          <p className="mt-2 text-muted-foreground ">s simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type</p>
          <div className="flex gap-7 mt-8">
            <div className="flex items-center flex-col ">
            <h2 className="font-bold text-6xl">8k+</h2>
            <p className="font-bold">Clientes</p>
            </div>
            <div className="flex items-center flex-col" >
            <h2 className="font-bold text-6xl">6k+</h2>
            <p className="font-bold">Produtos</p>
            </div>
            <div className="flex items-center flex-col">
            <h2 className="font-bold text-6xl">2k+</h2>
        ...
        <div className="mt-12 flex justify-center flex-col">
          ...
          <h1 className="font-bold text-6xl w-full text-center">Por que escolher-nos</h1>

          <p className="font-medium text-center mt-4" >Agendamento e gestao Financeira para empreendedores com excelencia e servicos personalizados de qualidade  superior</p>
        </div>

        <div className="flex items-center justify-center mt-12 mx-9 gap-6 ">
        ...
        <CardHeader>
          ...
          <CardContent>
          <p className="w-40"> is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s</p>
          </CardContent>
        </Card>
    ...
    <div className="flex justify-center mt-10">
      <h1 className="font-bold text-2xl">Voce tem alguma pergunta ? Obtenha ajuda nossa </h1>
    </div>
