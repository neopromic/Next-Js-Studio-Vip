  ...
  return (
    <>
      <section className="px-6 py-4">
        ...
        <section className="grid grid-cols-1 place-items-center md:grid-cols-4 justify-center gap-4">
          <Card className="w-80 h-max  mt-12 hover:size-11/12 hover:transition-all hover:size-11/12 hover:transition-all">
            <CardHeader>
              <Image
                height={320}
                width={200}
